    ...
    def hyper_params(self, size_params='small'):
        ...
        if self.dimension_embedding == 'doc_embedding':
            ...
            if self.flags_parameters.tfidf_stop_words:
                self.parameters['vect__tfidf__stop_words'] = hp.choice('vect__tfidf__stop_words', [None, True])
            else:
...
def get_embedding_index_tfidf(corpus, stopwords=True, language_text='fr', binary=False, vector_size=200, seed=15):
